...
export default function ConfirmationDialog() {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#191022]/80 backdrop-blur-[2px]">
      <div className="bg-progress-fill/30 border-progress-fill/30 flex flex-col items-center gap-4 rounded-[32px] border px-10 py-8 text-white backdrop-blur-[4px]">
        ...
        <div className="flex w-full gap-3">
          <button className="flex-1 rounded-xl bg-white/10 px-10 py-3 font-semibold hover:bg-white/20">
            Cancel
          </button>
          <button className="bg-accent-primary hover:bg-accent-bright flex-1 rounded-xl px-10 py-3 font-semibold">
            Reset
          </button>
        </div>
      </div>
